...
this.setOptions=function(newOptions){
    ...
    $o.addClass(options.classPrefix+'-outer area');
    $area.addClass(options.classPrefix+'-selection area');
    $border1.addClass(options.classPrefix+'-border1 area');
    $border2.addClass(options.classPrefix+'-border2 area');
    $a.css({
