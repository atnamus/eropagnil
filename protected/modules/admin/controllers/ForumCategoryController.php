...
class ForumCategoryController extends AdminController {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['ForumCategory'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success_msg', "Forum Category is created successfully");
...
// $this->performAjaxValidation($model);
        ...
        if (isset($_POST['ForumCategory'])) {
            $model->attributes = $_POST['ForumCategory'];
            if ($model->save()) {
                Yii::app()->user->setFlash('success_msg', "Forum Category is updated successfully");
                $this->redirect(array('update', 'id' => $model->id));
            }
        }
...
// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
     ...
     * @param ForumCategory $model the model to be validated
     */
