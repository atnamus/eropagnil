...
class LessonCategoryController extends AdminController {
    ...
    public function actionIndex() {
        ...
        if (isset($_GET['LessonCategory']))
            $model->attributes = $_GET['LessonCategory'];
...
// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
    ...
    public function loadModel($id) {
        $model = LessonCategory::model()->findByPk($id);
        if ($model === null)
     ...
     * @param LessonCategory $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'lesson-category-form') {
