...
class NewsletterSubscriberController extends AdminController {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['NewsletterSubscriber'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success_msg', "Newsletter Subscriber is created successfully");
...
// $this->performAjaxValidation($model);
        ...
        if (isset($_POST['NewsletterSubscriber'])) {
            $model->attributes = $_POST['NewsletterSubscriber'];
            if ($model->save()) {
                Yii::app()->user->setFlash('success_msg', "Newsletter Subscriber is updated successfully");
                $this->redirect(array('update', 'id' => $model->id));
            }
        }
