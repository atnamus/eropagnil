 ...
 */
class Lesson extends AdminModel {
    ...
    public function rules() {
        return array(
            array('language_id, title, user_id, stage_id, category_id, level, memo, status', 'required'),
    ...
    public function relations() {
        return array(
            ...
            'stage' => array(self::BELONGS_TO, 'LessonStage', 'stage_id'),
            'category' => array(self::BELONGS_TO, 'LessonCategory', 'category_id'),
            'quizs' => array(self::HAS_MANY, 'LessonQuiz', 'lesson_id'),
            'skits' => array(self::HAS_MANY, 'LessonSkit', 'lesson_id'),
        );
    }
