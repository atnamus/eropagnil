        ...
        <div class="portlet box <?php echo $this->portlet_color; ?>">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    View News #<?php echo $model->id; ?>                </div>                
            </div>
            <div class="portlet-body form">
                <form class="form-horizontal">
                    ...
                    <div class="form-actions right1">
                        <a href="<?php echo $this->createUrl('news/') ?>" class="btn <?php echo $this->back_button; ?>">Back</a>
                        <a href="<?php echo $this->createUrl('news/update/id/' . $model->id) ?>" class="btn <?php echo $this->update_button; ?>">Update</a>                       
                    </div>
                </form>
            </div>
        </div>
