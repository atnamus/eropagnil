                            ...
                            <li class="active-bt">
                              <div class="tab-cont-list" style='min-height:400px;'>
                                ...
                                foreach($latest_entries as $key=>$val){
                                  ...
                                  <div class="row">
                                    <div class="corct-list">
                                      <div class="col-md-1"><img src="<?php echo $this->profile_image_path . '/' . (($val['user']->profile_image != "") ? $val['user']->profile_image : $this->default_profile_pic); ?>" alt=""></div>
                                      <div class="col-md-10">
                                        <span><?php echo $val['user']->full_name; ?> </span>
